...
class Search(Tk):
    def __init__(self):
        ...
        self.img = ImageTk.PhotoImage(Image.open("res/student.png"))
        self.canvas.create_image(0, 0, anchor=NW, image=self.img)
        self.canvas.pack()
        self.iconbitmap(r'libico.ico')

        l1=Label(self,text="Search Student",bg='#3888FF', font=("Courier new",20,'bold')).place(x=290,y=40)
        l = Label(self, text="Search By",bg='#B3FFDB', font=("Courier new", 15, 'bold')).place(x=180, y=100)
        ...
        self.b= Button(self,text="Find",bg ='#3333FF',width=8,font=("Courier new",8,'bold'),command= ge )
        ...
        self.la = Label(self, text="Enter",bg = '#B3FFDB', font=("Courier new", 15, 'bold')).place(x=180, y=140)
