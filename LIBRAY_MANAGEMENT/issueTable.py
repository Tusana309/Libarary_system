...
class issue(Tk):
    def __init__(self):
        ...
        self.img = ImageTk.PhotoImage(Image.open("res/issue.png"))
...
#label and input box
        Label(self, text='Book Issuing',bg = '#3888FF', font=('Courier new', 24)).place(x=135, y=40)
        Label(self, text='Book ID',bg = '#B3FFDB', font=('Courier new', 15), fg='black').place(x=55, y=100)
        Entry(self, textvariable=c, width=40).place(x=160, y=106)
        Label(self, text='Student ID',bg = '#B3FFDB', font=('Courier new', 15), fg='black').place(x=20, y=150)
        Entry(self, textvariable=d, width=40).place(x=160, y=158)
        Button(self, text="ISSUE",bg='#3333FF', width=20, command=isb).place(x=200, y=200)
issue().mainloop()
